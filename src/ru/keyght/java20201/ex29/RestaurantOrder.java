...
public class RestaurantOrder<Item> implements Order {
    ...
    public boolean addFront(ru.keyght.java20201.ex29.Item x) {
        if (isEmpty())
            front = new InternetOrder<Item>((Item) x);
        else {
            InternetOrder<Item> temp = front;
            front = new InternetOrder<Item>(null, (Item) x, temp);
    ...
    @Override
    public boolean addFront(ru.keyght.java20201.ex29.Item x, HashMap<String, Order> hashMap) {
        return false;
    }
    ...
    public int remove(ru.keyght.java20201.ex29.Item x) {
        if (isEmpty())
            throw new NoSuchElementException("Element " + x.toString() + " not found");
    ...
    @Override
    public int remove(ru.keyght.java20201.ex29.Item x, HashMap<String, Order> hashMap) {
        return 0;
    }
    ...
    @Override
    public ru.keyght.java20201.ex29.Item getOrders(HashMap<String, Order> hashMap) {
        return null;
    }

    @Override
    public ru.keyght.java20201.ex29.Item massOrders() {
        return null;
    }

    @Override
    public ru.keyght.java20201.ex29.Item massOrderssorted() {
        return null;
    }
    ...
    @Override
    public int quantity(ru.keyght.java20201.ex29.Item x) {
        return 0;
    }

    @Override
    public ru.keyght.java20201.ex29.Item massOrdersnames() {
        return null;
    }
